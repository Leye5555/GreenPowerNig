...
navBar.addEventListener("click", () => {
    ...
    navBar.style.backgroundColor = "rgb(16, 31, 16)";
...
navBarToggle.addEventListener("click", () => {
    navSlide.classList.toggle("navSlideToggle"); 
    navBar.style.backgroundColor = "rgb(175, 171, 171)";
    navBar.style.border = "1px solid rgb(255, 255, 255)"
...
container.addEventListener("scroll", () => {
    ...
    // if (container.scrollTop >= 2097) {
    //     slides.style.animationPlayState = "running" ? "paused" : "running";
    // }
    // if (container.scrollTop < 2097 && container.scrollTop > 1273) {
    //     slides.style.animationPlayState = "paused" ? "running" : "paused";
    // }
    // if (container.scrollTop <= 1273) {
    //     slides.style.animationPlayState = "running" ? "paused" : "running";
    // }
